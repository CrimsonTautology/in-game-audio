...
unless Directory.exists?(root: true)
  ...
  root.find_or_create_subdirectory "dub", "Dub-Step"
  root.find_or_create_subdirectory "e", "Electronic"
  root.find_or_create_subdirectory "ex", "Experimental/Noise"
  ...
  root.find_or_create_subdirectory "mv", "Movie"
  root.find_or_create_subdirectory "po", "Pop"
  ...
  root.find_or_create_subdirectory "tv", "Television"
  root.find_or_create_subdirectory "v", "Video Games"

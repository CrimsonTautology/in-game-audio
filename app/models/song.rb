class Song < ActiveRecord::Base
  ...
  validates :sound_content_type,
    presence: true,
    inclusion: {in: %w(audio/mp3 audio/mp4 audio/mpeg3 audio/mpeg audio/x-mpeg3 audio/x-mpeg audio/ogg audio/flac audio/wav audio/wave audio/vnd.wave audio/x-wav audio/m4a audio/x-m4a) , message: "is invalid (%{value})" }
